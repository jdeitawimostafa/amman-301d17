...
// (line 187) it's undefined in console , because it's invoked out of the prototype itself , 
// and it's worked in line 183 because it's inside the prototype, 
// and the prototype it's releated to the constructor function . 
// 2. What is "this" when joe.scopeArrow() is invoked?
// also it's undefined in console . 
// 3. Explain why "this" is different when an arrow function is used.
// Inside of a regular function this is dynamic , it means that the value of this depends on how the function is invoked ,
// this in arrow function doesn’t define its own execution context , this value inside of an arrow function always 
// equals this value from the outer function ,  the arrow function resolves this lexically.
