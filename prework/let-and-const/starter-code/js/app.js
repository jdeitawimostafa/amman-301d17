...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT :  (because the rando variable is declared in the while loop , it should declare inside the function it self ,then we can print it in console,so the solution is deleted the console.log line for the rando variable )
  console.log(viewed);
